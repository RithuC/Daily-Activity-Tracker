...
var ActivityCollectionModel = function() {
    ...
    this.listeners = [];
    // Maintains a list of data points.
    this.dataPoints = [];
...
var GraphModel = function() {
    // Maintains a list of listeners.
    this.listeners = [];
    this.graphs = ['TableView', 'BarGraph'];
    this.currentGraph = 'TableView';
    this.notify = function(eventType, eventData) {
